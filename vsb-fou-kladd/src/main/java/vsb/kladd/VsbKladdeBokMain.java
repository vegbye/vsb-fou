...
import vsb.kladd.VsbMyClass.Indre;
import vsb.kladd.VsbMyClass.IndreStatisk;
...
public class VsbKladdeBokMain {
    ...
    private static void old() {
        ...
        Indre indre = vsbMyClass.new Indre();
        log.info(indre);

        IndreStatisk indreStatisk = new VsbMyClass.IndreStatisk();
